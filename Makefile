...
upload:
	docker build -t dellicon/products_microservice:latest -f ./Dockerfile .
	docker push dellicon/products_microservice:latest
	#APP_VERSION=latest docker-compose up

pull:
	sudo docker pull dellicon/products_microservice:latest
